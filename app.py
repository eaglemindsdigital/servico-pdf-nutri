...
def gerar_pdf():
    try:
        ...
        page.insert_text((1075, 550), dados["NOME"], fontsize=120, fontname="Helvetica-Bold", color=COR_BEGE)
        ...
        page.insert_text((1090, 2180), dados["PESO"], fontsize=64, fontname="Helvetica-Bold", color=COR_PRETO)
        page.insert_text((1070, 2290), dados["META KG"], fontsize=64, fontname="Helvetica-Bold", color=COR_PRETO)
        page.insert_text((1760, 2290), dados["GET"], fontsize=64, fontname="Helvetica-Bold", color=COR_PRETO)
        page.insert_text((730, 2400), dados["ALTURA"], fontsize=64, fontname="Helvetica-Bold", color=COR_PRETO)
        page.insert_text((750, 2505), dados["IDADE"], fontsize=64, fontname="Helvetica-Bold", color=COR_PRETO)
        ...
        page.insert_text((920, 6085), dados["META KG"], fontsize=64, fontname="Helvetica-Bold", color=COR_PRETO)
        page.insert_text((1160, 6085), "4", fontsize=64, fontname="Helvetica-Bold", color=COR_PRETO)
        page.insert_text((560, 13560), f"{dados['PESO']}kg", fontsize=100, fontname="Helvetica-Bold", color=COR_AZUL)
        page.insert_text((1860, 13560), f"{dados['PESO9DIAS']}kg", fontsize=100, fontname="Helvetica-Bold", color=COR_BRANCO)
        page.insert_text((1075, 32150), dados["NOME"], fontsize=100, fontname="Helvetica-Bold", color=COR_BEGE)
